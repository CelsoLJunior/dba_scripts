...
Select MOUNT_POINT,MB_TOTAL,MB_NAO_ORACLE, PERC_FOLGA_DESEJADA as "%folga desejada",
       ...
       system.imm$sgt_pkg.FNC_GET_ORACLE_USAGE(mount_point) Mb_Usado_pelo_DB,
       (Mb_Total - Mb_nao_Oracle - round((perc_folga_desejada/100)*mb_total)) - system.imm$sgt_pkg.FNC_GET_ORACLE_USAGE(mount_point) Mb_Free_no_FS
